	...
	theme: {
		...
		extend: {
			colors: {
				...
				encryption: {
					dark: 'hsl(var(--encryption-dark))',
					light: 'hsl(var(--encryption-light))'
				},
        trust: {
          bronze: 'hsl(var(--trust-bronze))',
          silver: 'hsl(var(--trust-silver))',
          gold: 'hsl(var(--trust-gold))',
          legend: 'hsl(var(--trust-legend))'
        }
			},
			borderRadius: {
				lg: 'var(--radius)',
        ...
        'bounce': {
          ...
          '50%': { transform: 'translateY(-4px)' }
			...
			animation: {
				...
				'pulse-encryption': 'pulse-encryption 2s ease-in-out infinite',
